...
@interface ZXPracticeVC ()<UITableViewDataSource,UITableViewDelegate,ZXPracticeToolBarDelegate,ZXPracticeCardDelegate>
@property (nonatomic,strong)UILabel *timeLabel;
@property (nonatomic,strong)UIView *topView;
@property (nonatomic,strong)UILabel *examLabel;
@property (nonatomic,strong)UITableView *customTable;
@property (nonatomic,strong)UIButton * answerBtn;
@property (nonatomic,strong)ZXPracticeToolBar *toolBar;
@property (nonatomic,strong)UIView *bgView;
@property (nonatomic,strong)ZXPracticeCard *answerCard;
...
//    paragraphStyle.firstLineHeadIndent = 20;
    ...
    answerBtn.frame = CGRectMake(0, CGRectGetMaxY(examLabel.frame) + 175, kViewWidth, 50);
    [answerBtn setTitleColor:color(55, 212, 142) forState:UIControlStateNormal];
    [answerBtn setTitleColor:color(235, 67, 67) forState:UIControlStateSelected];
    [answerBtn setTitle:@"恭喜您，答对了！" forState:UIControlStateNormal];
    [answerBtn setTitle:@"恭答错了！正确答案是：B" forState:UIControlStateSelected];
    [answerBtn setImage:[UIImage imageNamed:@"correct"] forState:UIControlStateNormal];
    [answerBtn setImage:[UIImage imageNamed:@"error"] forState:UIControlStateSelected];
    answerBtn.backgroundColor = color(255, 255, 255);
    answerBtn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    answerBtn.titleLabel.font = [UIFont systemFontOfSize:16];
    answerBtn.hidden = YES;
    [answerBtn setImageEdgeInsets:UIEdgeInsetsMake(0, 11, 0, 0)];
    [answerBtn setTitleEdgeInsets:UIEdgeInsetsMake(0, 18, 0, 0)];
    ...
    ZXPracticeCard *answerCard = [[ZXPracticeCard alloc] initWithFrame:CGRectMake(0, kViewHeight - 64 + 30, kViewWidth, kViewWidth)];
    answerCard.contentSize = CGSizeMake(kViewWidth, kViewWidth + 40);
    answerCard.practiceCardDelegate = self;
    ...
    ZXPracticeToolBar *toolBar = [[ZXPracticeToolBar alloc] initWithFrame:CGRectMake(0, kViewHeight - 49 - 64, kViewWidth, 49)];
    toolBar.practiceDelegate = self;
...
#pragma mark -
#pragma mark -ZXPracticeToolBar delegate
- (void)practiceToolBar:(ZXPracticeToolBar *)toolBar DidClickButton:(UIButton *)btn
{
    switch (btn.tag)
    {
        case ZXPracticeToolBarButtonTypeAnswerCard:
        {
            btn.selected = !btn.selected;
            if (btn.selected)
            {
        ...
        case ZXPracticeToolBarButtonTypeSubmit:
        {
