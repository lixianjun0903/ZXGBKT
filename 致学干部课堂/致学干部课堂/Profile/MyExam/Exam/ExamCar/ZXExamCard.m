...
{
    if ([self.examCardDelegate respondsToSelector:@selector(examCard:DidClickButton:)])
    {
        [self.examCardDelegate examCard:self  DidClickButton:btn];
    }
}
