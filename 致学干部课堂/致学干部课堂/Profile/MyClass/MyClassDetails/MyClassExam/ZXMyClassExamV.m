...
@interface ZXMyClassExamV()<UITableViewDataSource,UITableViewDelegate>
{
...
-(UITableViewCell* )tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZXMyClassExamCell * cell = [tableView dequeueReusableCellWithIdentifier:CELLID];
    if (!cell) {
        cell = [ZXMyClassExamCell myClassExamCell];
    }
    [cell setContentValue];
    return cell;
}
